...
import type { Shipment as _Shipment, Time as _Time, TrackingEvent as _TrackingEvent, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addTestShipments(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTestShipments();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addTrackingEvent(arg0: string, arg1: TrackingEvent): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTrackingEvent(arg0, to_candid_TrackingEvent_n1(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createShipment(arg0: string, arg1: string, arg2: string, arg3: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createShipment(arg0, arg1, arg2, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateTrackingNumber(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateTrackingNumber();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLatestTrackingEvent(arg0: string): Promise<TrackingEvent> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestTrackingEvent(arg0);
                return from_candid_TrackingEvent_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getShipment(arg0: string): Promise<Shipment> {
        if (this.processError) {
            try {
                const result = await this.actor.getShipment(arg0);
                return from_candid_Shipment_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async setInitialAdmin(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setInitialAdmin(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Shipment_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Shipment): Shipment {
    return from_candid_record_n8(_uploadFile, _downloadFile, value);
}
function from_candid_TrackingEvent_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TrackingEvent): TrackingEvent {
...
function from_candid_record_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        origin: value.origin,
        recipient: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.recipient)),
        events: from_candid_vec_n10(_uploadFile, _downloadFile, value.events)
    };
}
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_TrackingEvent>): Array<TrackingEvent> {
    return value.map((x)=>from_candid_TrackingEvent_n11(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Shipment>): Array<Shipment> {
    return value.map((x)=>from_candid_Shipment_n7(_uploadFile, _downloadFile, x));
}
function to_candid_TrackingEvent_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TrackingEvent): _TrackingEvent {
